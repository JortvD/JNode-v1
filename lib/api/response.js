...
var response = function(res, req, jnode) {
	...
	/**
	 * This function will prevent XSS attacks by replacing the harmful characters.
	...
	/**
	 * This function will get the key parameter from the request and send back the server's public key
	 * to establish an end-to-end encryption.
	 * @function handshake
	 */
	...
	self.emit = function() {
		...
		if(req.session != null && req.session["key"] != null) {
