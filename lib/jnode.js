...
var JNode = function() {
	...
	/**
	 * If the server will be single threaded or not. The default is false.
	 * @constant single_thread
	 */
	...
	self.start = function() {
		return new promise(function(t, c) {
			...
			add_flag("single_thread", self.single_thread);
	...
	self.favicon = function(file) {
		return router.route("favicon.ico", self.root + file);
	}
